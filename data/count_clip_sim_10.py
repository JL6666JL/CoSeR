...
file_path = ""
result_name = "data/ImageNet_10/Obj512_all/imagenet_all_clipcls.pkl"
feature_name = "data/ImageNet_10/Obj512_all/imagenet_all_clipcls_feature.npy"
...
paths = []
with open('data/ImageNet_10/Obj512_all/all.txt') as fin:
...
for path in tqdm(paths):
    path = '/data1/jianglei/coser_imagenet_10/'+path
...
df = pd.read_table('data/ImageNet_10/class.txt', sep='\t', header=None)
