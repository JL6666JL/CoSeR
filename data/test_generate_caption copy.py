...
result_name = f"data/ImageNet/Obj512_all/blip2_imagenet_captions_all_test.json"
...
for i in tqdm(range(0, num_images, batch_size)):
    ...
    generated_ids_with_prompt = model.module.generate(**inputs_with_prompt, max_new_tokens=20)
    ...
    generated_ids_with_question = model.module.generate(**inputs_with_question, max_new_tokens=20)
